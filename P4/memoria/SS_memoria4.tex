...
En resumen, la principal diferencia entre ambos métodos es el error de precisión a la hora de calcular el siguiente estado, por lo tanto para comprobar las diferencias entre estos dos métodos probaremos a ejecutar el sistema con distintos valores para el intervalo de cálculo y comparar las salidas.
