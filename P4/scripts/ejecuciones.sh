...
# S0 menor a b/a
../bin/practica4 0.001 0.125 0.1 0.1 1 100 1 120 0 runge > ../datos/tarea_2_2_menor.dat

# S0 mayor a b/a
../bin/practica4 0.001 0.125 0.1 0.1 1 100 1 130 0 runge > ../datos/tarea_2_2_mayor.dat

# S0 igual a b/a
../bin/practica4 0.001 0.125 0.1 0.1 1 100 1 125 0 runge > ../datos/tarea_2_2_mayor.dat
